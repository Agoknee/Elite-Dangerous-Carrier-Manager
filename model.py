...
class CarrierModel:
    ...
    def set_carrier_notes(self, carrier_notes: dict):
    ...
    def generateInfo(self, carrierID: int, now: datetime):
        ...
        carrier_notes = self.get_notes(carrierID)
    ...
    def get_notes(self, carrierID: int):
        return self.carrier_notes[str(carrierID)] if str(carrierID) in self.carrier_notes else ''
